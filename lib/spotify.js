...
exports.requestToken = function(authenticationInformation, callback) {
  var body = 'grant_type=' + authenticationInformation.grant_type;
  switch (authenticationInformation.grant_type) {
    case 'authorization_code':
      body += '&code=' + authenticationInformation.code + '&redirect_uri=' + authenticationInformation.redirect_uri;
      break;
    case 'refresh_token':
      body += '&refresh_token=' + authenticationInformation.refresh_token;
      break;
  }
  var headers = {
